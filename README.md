...
1. The core features of Node.js and Express and why they are useful.
      Node.js gives developers a chance to write a JS outside of the browser; and express give the user the ability to like mock the database languages in order to communicate with the database itself
1. Understand and explain the use of Middleware.
      Middleware is used to help limit trips to the database and perform validation checks while also extending functionality to an application
1. The basic principles of the REST architectural style.
      Everything is a resource, Each resource can be accessed by a unique URL, Resources can have multiple representations, uses a stateless protocol, and resource management is handled by HTTP methods.
